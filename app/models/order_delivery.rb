class OrderDelivery
  ...
  attr_accessor :user_id, :item_id, :postal_code, :delivery_area_id, :city, :block, :building_name, :phone_number

  with_options presence: true do
    validates :user_id
    validates :item_id
    validates :postal_code, format: {with: /\A[0-9]{3}-[0-9]{4}\z/, message:"○○○-○○○○の形式で入力してください"}
